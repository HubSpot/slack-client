...
public enum SlackMethod {
  api_test(MethodWriteMode.WRITE, RateLimitingTiers.TIER_4, JsonStatus.FORM_ENCODING_ONLY),
  ...
  auth_test(MethodWriteMode.WRITE, SpecialTier.of(200), JsonStatus.ACCEPTS_JSON),
