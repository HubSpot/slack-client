...
public class DefaultHttpResponseDebugger implements ResponseDebugger {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(
    DefaultHttpResponseDebugger.class
  );
  ...
  public void debug(
    ...
    LOG.debug(
      "REQ<{}> [{}, completion in {}ms]: Received \n\n{}",
      requestId,
      method,
      timer.elapsed(TimeUnit.MILLISECONDS),
      HttpFormatter.formatResponse(response)
    );
  }
  ...
  public void debugSlackApiError(
    ...
    LOG.error(
      "REQ<{}> [{}]: Failed interaction\n{}\n{}",
      requestId,
      method,
      HttpFormatter.formatRequest(request),
      HttpFormatter.formatResponse(failure)
    );
  }
  ...
  public void debugProactiveRateLimit(
    ...
    LOG.debug(
      "REQ<{}> [{}]: Proactively rate limited request\n{}",
      requestId,
      method,
      HttpFormatter.formatRequest(request)
    );
