...
public class ChatScheduleMessageResponseDeserializationTest {
  ...
  public void itDeserializesChatScheduleMessageResponse() throws IOException {
    ChatScheduleMessageResponse chatScheduleMessageParams = fetchAndDeserializeChatScheduleMessageResponse(
      "chat_schedule_message_response.json"
    );
  ...
  private ChatScheduleMessageResponse fetchAndDeserializeChatScheduleMessageResponse(
    String jsonFileName
  ) throws IOException {
    String rawJson = JsonLoader.loadJsonFromFile(jsonFileName);
    return ObjectMapperUtils
      .mapper()
      .readValue(rawJson, ChatScheduleMessageResponse.class);
  }
}
