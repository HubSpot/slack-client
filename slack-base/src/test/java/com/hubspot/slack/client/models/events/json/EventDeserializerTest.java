...
public class EventDeserializerTest {
  ...
  public void itCanDeserMemberJoinedChannelEventWithoutInviter() throws IOException {
    SlackMemberJoinedChannelEvent event = fetchAndDeserializeSlackEvent(
  ...
  public void itCanDeserMemberLeftPublicChannelEvent() throws IOException {
    SlackMemberLeftChannelEvent event = fetchAndDeserializeSlackEvent(
  ...
  public void itCanDeserUserChangeEvent() throws IOException {
    SlackUserChangeEvent event = fetchAndDeserializeSlackEvent("user_change.json")
      .toDetailedEvent();
  ...
  public void itCanDeserLinkSharedEvent() throws IOException {
    SlackLinkSharedEvent event = fetchAndDeserializeSlackEvent("link_shared.json")
      .toDetailedEvent();
  ...
  public void itCanDeserLinkSharedEventWithThreadTs() throws IOException {
    SlackLinkSharedEvent event = fetchAndDeserializeSlackEvent(
