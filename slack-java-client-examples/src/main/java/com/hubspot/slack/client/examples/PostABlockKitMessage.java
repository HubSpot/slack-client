...
public class PostABlockKitMessage {
  ...
  public static ChatPostMessageResponse messageChannel(
    String channelToPostIn,
        ...
        ChatPostMessageParams
          ...
          .setBlocks(
            Arrays.asList(
              ...
              Blocks
                .markdownSection("`12/01` *Toby's Going Away Party* at _Benihana_")
              ...
              Blocks
                .markdownSection("`10/21` *Conference Room Meeting*")
                .withAccessory(
